...
const { all_user, add_agent_sendango, add_user, one_user, user_login, delete_user, update_user, one_user_by_tel, one_user_by_type_user, one_user_by_status } = require('../controllers/user')
